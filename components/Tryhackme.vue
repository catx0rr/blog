<template>
  <div id='thm_badge' class='thm_margin' onClick="location.href='https://tryhackme.com/p/catx0rr'">
    <div style="width: auto; border-radius:4px; margin-right: 0px;">
      <div class="thm_avatar" style="background-image: url(https://tryhackme-images.s3.amazonaws.com/user-avatars/824fa3192bc5dd27f5cc09e8433a6d43.png)"></div>
    </div>
    ...
    <div class="thm_font" style="box-sizing: content-box; height:50px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding-left: 8px; padding-top: 5px;">
      <p class="thm_line" style='margin-bottom: 3px;'><span class="thm_nickname">catx0rr</span> <span class="thm_rank">[0x6]</span><br></p>
      <p class="thm_line" style='margin-bottom: 1px; display: flex; align-items:center;'>
        <img class="thm_icon thm_mr" src="https://tryhackme.com/img/badges/trophy.png" alt='trophy'> <span class="thm_stat thm_mr">7953</span>
        <img class="thm_icon thm_mr" src="https://tryhackme.com/img/badges/door.png" alt='door'> <span class="thm_stat thm_mr">18</span>
        <img class="thm_icon thm_mr" src="https://tryhackme.com/img/badges/target.png" alt='target'> <span class="thm_stat">5</span><br>
      </p>
      <p class="thm_line">
